...
int MAX_RESOURCES = 10; // m
int MAX_PROCESSES = 5;  // n
...
bool isSafeState(int nor, int nop, vector<int> available, vector<vector<int>> allocation, vector<vector<int>> need, vector<bool> finished)
{
